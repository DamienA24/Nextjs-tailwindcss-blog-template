...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark dark:bg-accentDark m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      <div className="w-full  md:mt-0 mt-16 relative font-medium py-6 px-8 flex  flex-col md:flex-row items-center justify-between">
        ...
        <div className="text-center">Made with &hearts;</div>
      </div>
    </footer>
  );
};
